...
public class Bosque extends Base implements RecursoFonte {
    ...
    public Bosque(int x, int y, FX_CG_2D_API api, int qntdade) {
        this.x = x;
        this.y = y;
        this.api = api;
    ...
    public Bosque(int x, int y, FX_CG_2D_API api, Reino reino) {
        this.x = x;
        this.y = y;
        this.api = api;
        this.reino = reino;
    ...
    public void desenhar() {
        ...
        api.preenchimento(Color.GREENYELLOW);
