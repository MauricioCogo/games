...
public class MinaFerro extends Base implements RecursoFonte {
    ...
    public MinaFerro(int x, int y, FX_CG_2D_API api, int qntdade) {
        this.x = x;
        this.y = y;
        this.api = api;
    ...
    public MinaFerro(int x, int y, FX_CG_2D_API api, Reino reino) {
        this.x = x;
        this.y = y;
        this.api = api;
        this.reino = reino;
